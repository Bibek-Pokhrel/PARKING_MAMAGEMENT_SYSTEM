...
#    print(px)
    ...
    free_spaces = len(list2) - car_count
    cvzone.putTextRect(
        frame, f'Number of cars: {car_count}', (50, 60), 2, 2)
    cvzone.putTextRect(
        frame, f'Free spaces: {free_spaces}', (50, 160), 2, 2)
